...
namespace Com.Mygame
{
    ...
    public class MyCharacterController
    {
        ...
        //readonly Moveable moveableScript; // 删除部分
        ...
        /*public void moveToPosition(Vector3 destination) 删除部分
        {
        ...
        public void reset()
        {
            ...
            character.transform.position = coastController.getEmptyPosition();
    ...
    public class CoastController
    {
        ...
        {
            positions = new Vector3[] {new Vector3(-6.5F,2.40F,0), new Vector3(-7.5F,2.40F,0), new Vector3(-8.5F,2.40F,0),
                new Vector3(-9.5F,2.40F,0), new Vector3(-10.5F,2.40F,0), new Vector3(-11.5F,2.40F,0)};
            ...
            {
                coast = Object.Instantiate(Resources.Load("Perfabs/RightCoast", typeof(GameObject)), to_pos, Quaternion.identity, null) as GameObject;
                coast.name = "to";
                to_or_from = -1;
            }
        }
